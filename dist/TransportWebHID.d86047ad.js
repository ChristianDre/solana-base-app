...
})({"ntgnS":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
 ...
 */ var TransportWebHID = function(_super) {
    ...
    function TransportWebHID1(device) {
        ...
        _this1.channel = Math.floor(Math.random() * 65535);
...
var identifyTargetId = function(targetId) {
    var deviceModel1 = devicesList.find(function(_a2) {
        ...
        return masks.find(function(mask) {
            return (targetId & 4294901760) === mask;
        });
    });
    return deviceModel1;
};
...
var identifyProductName = function(productName) {
    ...
    if (!productId && productName.startsWith("Nano S")) productId = DeviceModelId.nanoSP;
...
},{"process":"d5jf4"}],"kgTdE":[function(require,module,exports) {
...
const parseOptions = (options1)=>!options1 ? {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["ntgnS"], null, "parcelRequire6a51")
